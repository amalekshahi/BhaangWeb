...
<div ng-controller="myCtrl" id="myCtrl">
		...
		<!--<style type="text/css">
			.dataTables_length1{ float: right !important;}
			.dataTables_filter1{text}
		</style>-->
		...
		<div class="dataTables_info" id="DataTables_Table_1_info" role="status" aria-live="polite"></div> -->
			...
			<table datatable="ng" dt-options="dtOptions" class="display" style="" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info" role="grid" >
				<thead>
				<tr>
				</tr>
				</thead>
