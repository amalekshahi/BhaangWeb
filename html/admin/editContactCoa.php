                    ...
                    <div class="ibox float-e-margins">                        
                        <div class="ibox-content">
						      <form id="idForm">
								...
								<div class="form-group">Send this file: <input name="file" id="fileUpload" type="file" />
								...
								<div id="fieldDiv" style="display:none;" class="form-group"><label class="col-sm-2 control-label">Header</label>
                                    <div id="headerdiv" class="col-sm-10">																	
                                    </div>
                                </div>

                        
								<div id="importNameDiv" style="display:none;" class="form-group"><label class="col-sm-2 control-label">Import Name</label>
									<div class="col-sm-10"><input type="text" class="form-control" name="importName" id="importName" placeholder="Import Name" >
                                    </div>
                                </div>								 
								<br>
								<br>
								<div id="buttonDiv" style="display:none;" class="form-group">
