								...
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<select chosen multiple placeholder-text-multiple="'Choose Your Lists...'" ng-model="filterList" ng-options="s.contactID as s['LIST-NAME']+' ['+s['LIST-COUNT']+' people]' for s in audience.items" ng-change="ArrangeFilter()">
													<option value=""></option>
												</select>
														...
														<div class="input-group form-group-sm"  ng-show="emailDone > 0">
															...
															<br>
															 ...
															 ng-change="dateChange('')" required="">
																		<span id="datespan1" class="input-group-addon" onclick="showcalendar();">
