...
<div class="ibox float-e-margins" ng-show="showreport==true" ng-controller="dvreport">
	...
	<div class="ibox-content" id="reportDiv">
		<div class="row">
			...
			<div class="col-xs-2"><small class="stats-label"><i aria-hidden="true" class="fa fa-dot-circle-o" style="color:blue"></i> Conversions</small></div>
		</div>
		...
		<div class="row">
			<div class="col-xs-2"><h2>{{campaign.reportSumarySent | number}}</h2></div>
			<div class="col-xs-2"><h2>{{campaign.reportSumaryDelivered | number}} ({{campaign.reportSumaryDeliveredRate | number:0}}%)</h2></div>
			<div class="col-xs-2"><h2>{{campaign.reportSumaryOpened | number}} ({{campaign.reportSumaryOpenedRate | number:0}}%)</h2></div>
			<div class="col-xs-2"><h2>{{campaign.reportSumaryClicked | number}} ({{campaign.reportSumaryClickedRate | number:0}}%)</h2></div>
			<div class="col-xs-2"><h2>{{campaign.reportSumaryUnsubscribed | number}} ({{campaign.reportSumaryUnsubscribedRate | number:0}}%)</h2></div>
			<div class="col-xs-2"><h2>{{campaign.reportSumaryConversions | number}} ({{campaign.reportSumaryConversionsRate | number:0}}%)</h2></div>
		</div>
	</div>
</div>
