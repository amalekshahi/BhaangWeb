(function() {
    ...
    SelectParser = function() {
        ...
        }, AbstractChosen.prototype.append_option = function(a) {
        ...
        }, AbstractChosen.default_multiple_text = "Select Some Options", AbstractChosen.default_single_text = "Select an Option", AbstractChosen.default_no_result_text = "No results match", AbstractChosen.default_create_option_text = "Add Option", AbstractChosen
        ...
        return d(Chosen, c), Chosen.prototype.setup = function() {
            ...
            var b, c;
            return this.result_highlight ? (b = this.result_highlight, b.hasClass("create-option") ? (this.select_create_option(this.search_field.val()), this.results_hide()) : (this.result_clear_highlight(), this.is_multiple && this.max_selected_options <= this.choices_count() ? (this.form_field_jq.trigger("chosen:maxselected", {
                chosen: this
        ...
        }, Chosen.prototype.show_create_option = function(b) {
            var c;
            return c = a('<li class="create-option active-result"><a>' + this.create_option_text + '</a>: "' + b + '"</li>'), this.search_results.append(c)
        }, Chosen.prototype.create_option_clear = function() {
            return this.search_results.find(".create-option").remove()
        }, Chosen.prototype.select_create_option = function(b) {
            return a.isFunction(this.create_option) ? this.create_option.call(this, b) : this.select_append_option({
                value: b,
                text: b
            })
        }, Chosen.prototype.select_append_option = function(b) {
            var c;
            return c = a("<option />", b).attr("selected", "selected"), this.form_field_jq.append(c), this.form_field_jq.trigger("chosen:updated"), this.form_field_jq.trigger("change"), this.search_field.trigger("focus")
        }, Chosen.prototype.no_results_clear = function() {
            return this.search_results.find(".no-results").remove()
        }, Chosen.prototype.keydown_arrow = function() {
            var a;
            return this.results_showing && this.result_highlight ? (a = this.result_highlight.nextAll("li.active-result").first()) ? this.result_do_highlight(a) : void 0 : this.results_showing && this.create_option ? this.result_do_highlight(this.search_results.find(".create-option")) : this.results_show()
