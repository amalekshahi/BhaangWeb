...
myApp.controller('myNewCtrl',function($rootScope,$scope,$http) {
			...
			$scope.LoadNewPageStart = function() { 
				$scope.LoadNewPageDefault('new');	
				//set option on start
				$('#femailRequire').option[0].selected;
				$('#femailPrefill').option[1].selected;
				$('#fnameRequire').option[0].selected;
				$('#fnamePrefill').option[1].selected;
            };		
			$scope.LoadNewPageStart(); 
