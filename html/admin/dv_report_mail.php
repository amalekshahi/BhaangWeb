...
<div class="ibox float-e-margins" ng-show="showreport==true" ng-controller="dvreport">
	...
	<div class="ibox-content" id="reportDiv">
		<div class="row">
			...
			<div class="col-xs-2"><small class="stats-label"><i aria-hidden="true" class="fa fa-envelope-open-o" style="color:blue"></i>	Delivered</small></div>
		...
		<div class="row" ng-repeat="item in campaign.report">
			...
			<div class="col-xs-2"><h2>{{item.Delivered}}</h2></div>
