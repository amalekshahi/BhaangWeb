 ...
 */
define('CHANGELOG_FILE', '/usr/share/doc/phpMyAdmin/ChangeLog');

/**
 * Path to license file. Useful when you want to have documentation somewhere
 * else, eg. /usr/share/doc.
 */
define('LICENSE_FILE', '/usr/share/licenses/phpMyAdmin/LICENSE');
 ...
 */
define('SQL_PARSER_AUTOLOAD', '/usr/share/php/SqlParser/autoload.php');
